...
6. Copy and paste the contents of either [`free-agario-bots.vanilla.user.js`](https://github.com/decagraff/agarbot/raw/master/free-agario-bots.vanilla.user.js)or [`HSLO BOTS SCRIPT.user.js`](https://github.com/decagraff/agarbot/raw/master/HSLO BOTS SCRIPT.user.js) into a new Tampermonkey userscript and save it
